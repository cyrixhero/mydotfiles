...
values."
  (setq-default
   ...
   '(
     ...
     common-lisp
     elfeed
     ;; To define a feed list of org files:
     (elfeed :variables
   ...
   dotspacemacs-additional-packages '(hackernews emms)
...
you should place your code here."
  ...
  (setq
   user-mail-address "zhan@cyrixhero.net"
   user-full-name  "TĀM KHUN‧HONG"
   ;; message-signature
   ;;  (concat
   ;;    "Foo X. Bar\n"
