...
values."
  (setq-default
   ...
   '(
     ...
     (elfeed :variables
             rmh-elfeed-org-files (list "~/mydotfiles/elfeed.org"))
     emacs-lisp
     (erc :variables
          erc-server-list
          '(("irc.freenode.net"
